...
function editgesture(cfg1, cfg2, obj1, obj2) {
	...
	for (var i = 0; i < config[cfg1][cfg2].length; i++) {
		...
		if (obj1 == "s" || obj1 == "r") {
			if (i == 0) {
				_action.innerHTML = CMi18n("scractup");
			} else {
				_action.innerHTML = CMi18n("scractdown");
			}
		} else if (obj1 == "u") {
			if (i == 0) {
				_action.innerHTML = CMi18n("stractmiddle");
			} else {
				_action.innerHTML = CMi18n("stractright");
			}
		} else if (obj1 == "v") {
			if (i == 0) {
				_action.innerHTML = CMi18n("stractleft");
			} else {
				_action.innerHTML = CMi18n("stractright");
			}
		} else if (obj1 == "w") {
		...
		/*gesture*/
		for (var j in config[cfg1][cfg2][i].direct) {
			if (obj1 == "s" || obj1 == "r" || obj1 == "u" || obj1 == "v" || obj1 == "w") {
				break;
			}
	...
	for (var i = 0; i < document.getElementsByClassName(obj1 + "wrap").length; i++) {
		var _fnmoresave = function _fnmoresave() {
		...
		for (var ii in moreArray) {
			...
			if (moreArray[ii] == "moreTarget" || moreArray[ii] == "moreTsearch" || moreArray[ii] == "moreIsearch" || moreArray[ii] == "moreChromepage" || moreArray[ii] == "morePosition" || moreArray[ii] == "morePinned" || moreArray[ii] == "moreCapturetype" || moreArray[ii] == "moreClosesel" || moreArray[ii] == "moreCloseopts") {
