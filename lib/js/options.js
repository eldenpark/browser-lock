...
var action = {
    ...
    image: [{ action: "G_none" }, { action: "I_open" }, { action: "I_save" },
    //		{action:"I_saveback"},
    { action: "I_copyurl" }, { action: "I_search" }, { action: "I_searchuser" }],
...
/*fast reset config*/
document.getElementById("fastreset").innerHTML = CMi18n("fastreset");
...
function crxChange(e) {
    ...
    if (_obj.className == "norselect" || _obj.className == "gesselect" || _obj.className == "drgselect" || _obj.className == "strselect") {
        var cfg1, cfg2;
        cfg2 = _obj.id;
    ...
    if (_obj.id.indexOf("select") != -1) {
        ...
        if (!e.target.nextSibling) {} else if (e.target.nextSibling && e.target.nextSibling.className == "morehold") {
        ...
        var moreEle = [];
        var defaultDes = "";
        if (_obj.value == "G_newtab" || _obj.value == "G_openclipurl" || _obj.value == "G_reclosedtab" || _obj.value == "G_crxsettings") {
            moreArray = ["moreTarget", "morePosition", "morePinned", "moreDes"];
            defaultDes = CMi18n(_obj.value);
        } else if (_obj.value == "G_viewsource" || _obj.value == "G_newtab" || _obj.value == "L_open" || _obj.value == "I_open") {
            moreArray = ["moreTarget", "morePosition", "morePinned", "moreDes"];
            defaultDes = CMi18n(_obj.value);
        ...
        } else if (_obj.value == "G_newusertab" || _obj.value == "T_searchuser" || _obj.value == "I_searchuser") {
        ...
        if (moreArray.length != 0) {
            var _fnmoresave = function _fnmoresave(e) {
            ...
            for (var ii in moreArray) {
                if (moreArray[ii] == "moreTarget" || moreArray[ii] == "moreTsearch" || moreArray[ii] == "moreIsearch" || moreArray[ii] == "moreChromepage" || moreArray[ii] == "morePosition" || moreArray[ii] == "morePinned" || moreArray[ii] == "moreCapturetype" || moreArray[ii] == "moreCloseopts" || moreArray[ii] == "moreClosesel") {
...
function FnAddOk(e) {
    ...
    for (var i in config[_cfg1][_cfg2]) {
...
function liclick(e) {
    if (e.target.dataset.i18ninner == "normal" || e.target.dataset.i18ninner == "gesture" || e.target.dataset.i18ninner == "drag" || e.target.dataset.i18ninner == "scroll" || e.target.dataset.i18ninner == "scrollgesture" || e.target.dataset.i18ninner == "strokegesture") {
        document.getElementById("optname").innerHTML = CMi18n(e.target.dataset.i18ninner) + "\<a href='###' data-reset='" + e.target.dataset.i18ninner + "'\>" + CMi18n("resetpage") + "\<\/a\>";
    } else {
        document.getElementById("optname").innerHTML = CMi18n(e.target.dataset.i18ninner);
    }
...
function FnDel(e) {
    ...
    for (var i in config[_cfgobj1][_cfgobj2]) {
...
function selectbackground(e) {
    if (e.target.id.substr(0, 1) == "g" || e.target.id.substr(0, 1) == "s" || e.target.id.substr(0, 1) == "r") {
...
(function addRateUs() {
    var createStar = function createStar(id) {
